...
class TestEntity(unittest.TestCase):
    ...
    def test_entity_state_at_a_given_time(self):
        entity = Entity(geocode = "76987", geoname = "Gulu", unique_name = "Ashianti")
        entity.save()
    ...
    def test_entity_state_at_a_given_time(self):
        entity = Entity(geocode = "76910", geoname = "Gulu", unique_name = "Ashianti")
        entity.save()
        ...
        entity_state = entity.state({'arv':'latest', 'patients':'sum'})
        self.assertEqual(entity_state, {'patients':1, 'arv':1})
